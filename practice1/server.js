...
const students = [
    { id: 1, name: "Kchoeying", age: 19, course: "Software Engineering" },
    { id: 2, name: "Sonam Zangmo", age: 19, course: "Computer Science" },
    { id: 3, name: "motay", age: 19, course: "Mechanical Engineering" },
    { id: 4, name: "Thinley", age: 20, course: "Civil Engineering" }
];
